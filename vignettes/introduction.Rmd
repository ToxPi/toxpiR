...
Depending on output method and operating system, plot resolution may end up poor. PDF images tend to produce the best results, shown in a comparison below. Optional code is provided to create smoother lines and improve plot clarity, notably in the center of the profile. The rest of the plots in this vignette are rendered through html.
...
# Save plot as pdf (shown embedded below on the right)
pdf(file = "example.pdf")
plot(f.results, package = "gg")
dev.off()
```
...
<div>
![](embeddedFigures/txp_PDF.pdf){height="357px"}
</div>
...
coord_munch_new <- function(coord, data, range, segment_length = 1/1000, is_closed = FALSE) {
...
# Revert to original coord_munch
...
<!-- knitr::include_graphics("embeddedFigures/coord_munch_orig.png") -->
<!-- knitr::include_graphics("embeddedFigures/coord_munch_new.png") -->
<!-- ``` -->
