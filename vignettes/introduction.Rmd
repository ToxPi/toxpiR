...
Depending on output method and operating system, plot resolution may end up poor. SVG and PDF images tend to produce better results than PNG. Optional code is provided to create smoother lines and improve plot clarity, notably in the center of the profile. The plots in this vignette are SVG. Usage and example plot output are shown below.
```{r, eval=FALSE}
library("ggplot2")
